...
.wa-label::after{
    ...
    <div class="float-btn" onclick="toggleTheme()" id="theme-btn">
        🌙
    </div>

    <div class="float-btn" onclick="toggleMusic()" id="music-btn">
        🎵
    </div>

    <div class="float-btn" onclick="backToCover()" id="back-btn">
        🔙
    </div>
